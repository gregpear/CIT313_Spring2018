...
<html lang="en">
  <head>
    ...
    <link href="<?php echo BASE_URL?>views/css/bootstrap-responsive.css" rel="stylesheet"><?php
    if($u->isAdmin()) {
      ?><link rel="stylesheet" href="<?php echo BASE_URL?>application/plugins/tinyeditor/tinyeditor.css"><?php
    }
